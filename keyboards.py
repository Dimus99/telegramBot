...
startKeyboard.add(types.InlineKeyboardButton( 'Пойти нахуй', callback_data='нахуй'))

askKeyboard = types.InlineKeyboardMarkup()
askKeyboard.add(types.InlineKeyboardButton( 'Разолслать всем, что день прошел необычно', callback_data='ask_Всё хуйня' ))
